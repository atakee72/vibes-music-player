...
| Re-scan tags | `af49e20` — `fix: merge re-scan patches against live state; skip no-op cover swaps` (Refresh's counterpart for in-place tag edits — beets — that leave paths unchanged) |
